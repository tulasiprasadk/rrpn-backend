-- Migration: subscription engine schema (Postgres)
-- Created by assistant for Supabase/Postgres
...
-- Example default category rules
INSERT INTO category_rules (category, rules)
SELECT * FROM (VALUES

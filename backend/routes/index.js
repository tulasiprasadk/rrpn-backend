...
import supplierAuth from "./supplier/auth.js";
...
import adminDevLogin from "./admin/dev-login.js";
...
router.use("/admin/ads", adminAds);
router.use('/admin/upload', adminUpload);
router.use('/admin/dev-login', adminDevLogin);
...
router.use("/subscription-engine", subscriptionEngine);

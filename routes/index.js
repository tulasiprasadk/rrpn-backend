...
router.use("/admin/ads", (await import('./admin/ads.js')).default);
router.use('/admin/upload', (await import('./admin/upload.js')).default);
router.use('/admin/dev-login', (await import('./admin/dev-login.js')).default);
